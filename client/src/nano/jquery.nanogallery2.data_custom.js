/**!
 * @preserve nanogallery2 - Custom data provider
 *
...
// ########################################################
// ##### nanogallery2 - module for Custom data source #####
// ########################################################
...
// ;(function ($) {
  ...
  jQuery.nanogallery2.data_custom = function (instance, fnName){
    ...
    var AlbumGetContent = function(albumID, fnToCall, fnParam1, fnParam2) {
      ...
      var kind = 'image';
        ...
        if( G.O.photoset.toUpperCase() == 'NONE' || G.O.album.toUpperCase() == 'NONE' ) {
          ...
          kind='album';
            ...
            // FIX: Hent bilder fra et gitt album
      ...
      if( G.O.debugMode ) { console.log('Provider URL: ' + url); }
